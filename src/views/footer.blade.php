<footer class='footer'>
    ...
    <ol class='footer__links'>
        ...
        <li><a href='https://twitter.com/blokkshq' target='_blank' rel='noopener' class='footer__link'>@lang('brochure.footer.twitter')</a></li>
        <li><a href='https://blokks.co/docs' target='docs' rel='noopener' class='footer__link footer__link--docs'>@lang('brochure.footer.documentation')</a></li>
    </ol>
    ...
    <div class='footer__legal'>
        ...
        <a href='https://blokks.pr.co/163673-blokks-helps-festivals-and-conferences-create-customise-and-manage-their-event-schedules' rel='noopener' target='_blank' class='footer__link footer__link--privacy'>@lang('brochure.footer.press')</a>
